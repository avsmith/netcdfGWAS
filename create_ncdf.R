...
# mach1 --datfile sample.dat --pedfile sample.ped --phase --prefix sample.pp
# minimac2 command to impute
# minimac2 --refHaps hapmap.hap --refSnps hapmap.snps --haps sample.pp.gz --snps sample.snps --prefix chr99.imp
